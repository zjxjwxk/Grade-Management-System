  ...
  <body class="app sidebar-mini rtl">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li><a class="app-menu__item active" href="/teacher/scoreInsert"><i class="app-menu__icon fa fa-edit"></i><span class="app-menu__label">成绩录入</span></a></li>
      </ul>
    </aside>
    <main class="app-content">
      <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="/teacher/scoreInsert">成绩录入</a></li>
        </ul>
      </div>
      <div class="row">
        <div class="col-md-12">
      ...
      <div class="row">
        <div class="col-md-12">
          <form class="tile" action="/teacher/insertScore" method="post">
            <div class="tile-body">
                ...
                <tbody>
                    <c:forEach items="${myStuToInsertScoreList}" var="student" varStatus="status">
                        <tr>
                            ...
                            <td><input class="form-control col-md-3" type="number" name="score"></td>
                        </tr>
                    </c:forEach>
                </tbody>
              </table>
