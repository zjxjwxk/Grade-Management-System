  ...
  <body class="app sidebar-mini rtl">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li><a class="app-menu__item active" href="/admin/department"><i class="app-menu__icon fa fa-building"></i><span class="app-menu__label">专业管理</span></a></li>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-building"></i> 专业管理</h1>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item"><a href="/admin/department">专业管理</a></li>
        </ul>
      </div>
        <div class="row">
            <div class="col-md-12">
                <div class="tile">
                    <form class="form-group col-md-12" action="/admin/insertDepartment">
                        <div class="row">
                            <div class="col-lg-4">
                                <label>专业编号</label>
                                <input class="form-control" type="text" name="ID" placeholder="请输入专业编号" required>
                            </div>
                            <div class="col-lg-4">
                                <label>专业名称</label>
                                <input class="form-control" type="text" name="name" placeholder="请输入专业名称" required>
                            </div>
                        </div>
