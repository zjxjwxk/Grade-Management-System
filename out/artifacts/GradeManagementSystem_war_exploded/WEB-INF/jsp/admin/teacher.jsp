  ...
  <body class="app sidebar-mini rtl">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li><a class="app-menu__item active" href="/admin/teacher"><i class="app-menu__icon fa fa-user"></i><span class="app-menu__label">教师管理</span></a></li>
    ...
    <main class="app-content">
      <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="/admin/teacher">教师管理</a></li>
        </ul>
      </div>
        <div class="row">
            <div class="col-md-12">
                <div class="tile">
                    <form class="form-group col-md-12" action="/admin/insertTeacher">
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-lg-3">
                                    <label>年龄</label>
                                    <input class="form-control" type="text" name="age" placeholder="请输入年龄" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
